Fork from https://github.com/ShaderFrog/glsl-parser
...
1. Each function _mutates_ the AST to rename identifiers in place.
2. They _return_ an _immutable_ new ScopeIndex where the scope references
